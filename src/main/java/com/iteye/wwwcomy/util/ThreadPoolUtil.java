...
/**
 * 不要开过多线程池，还是要共用（ThreadPoolExecutor已经控制并共享了线程数）
 */
public class ThreadPoolUtil {
	...
	public static final ThreadPoolExecutor newPool(int P, int M, int K, BlockingQueue<Runnable> Q,
			RejectedExecutionHandler R) {
